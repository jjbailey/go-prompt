...
This repository is a fork of github.com/c-bata/go-prompt, provided to add
...
will set the title to an empty string if it is not explicity set with OptionTitle.
Untested.
