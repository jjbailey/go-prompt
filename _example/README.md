...
![simple-input](https://github.com/jjbailey/assets/raw/master/go-prompt/examples/input.gif)

A simple echo example using `prompt.Input`.

## http-prompt

![http-prompt](https://github.com/jjbailey/assets/raw/master/go-prompt/examples/http-prompt.gif)

A simple [http-prompt](https://github.com/eliangcs/http-prompt) implementation using go-prompt in less than 200 lines of Go.

## live-prefix

![live-prefix](https://github.com/jjbailey/assets/raw/master/go-prompt/examples/live-prefix.gif)
...
More practical example is [a source code of kube-prompt](https://github.com/jjbailey/kube-prompt).
